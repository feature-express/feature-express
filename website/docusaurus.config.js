...
const config = {
  ...
  tagline: 'Unlocking Insights Through Time',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/feature-express',
              },
              {
                label: 'Discord',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Paweł Jankiewicz, Inc. Built with Docusaurus.`,
      },
      prism: {
